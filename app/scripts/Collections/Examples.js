const Examples = [
  {
    ...
    projectImages: ['/assets/Waggle/LandingPageBrunch.png', '/assets/Waggle/MatchedView.png', '/assets/Waggle/MobileMapView.png', '/assets/Waggle/SearchResultsPage.png', '/assets/Waggle/Code_ResultsPage.png'],
